...
Router.map(function () {
	...
	this.route("shows", {path: "/shows", controller: "ShowsController"});
	this.route("shows.insert", {path: "/shows/insert", controller: "ShowsInsertController"});
	this.route("shows.edit", {
		path: "/shows/edit",
		controller: "ShowsEditController",
		data: function() {
			return POLL.findOne(this.params.titleId);
		}})
