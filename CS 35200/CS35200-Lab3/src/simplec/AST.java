...
public abstract class AST {
    ...
    /* Units */
        ...
        @Override
        public Void visit(Expression.Equality expr) {
            visit(expr.left, expr);
            say(" ");
            say(expr.token);
            say(" ");
        ...
        @Override
        public Void visit(Expression.Str str) {
            say(str.value);
            return null;
        }
        ...
        public Void visit(Expression.Call call) {
            ...
            say("(");
            if (call.args.size() == 1) {
                call.args.get(0).accept(this);
            } else if (call.args.size() > 1) {
                for (int i = 0; i < call.args.size(); i++) {
                    if (i == (call.args.size() - 1)) {
                        call.args.get(i).accept(this);
                        break;
                    }
                    call.args.get(i).accept(this);
                    System.out.print(", ");
    ...
    /* Statements */
        ...
        @Override
        public Void visit(Statement.Call call) {
            indent(i);
            say(call.id);
            say("(");
            if (call.args.size() == 1) {
        ...
        @Override
        public Void visit(Statement.WhileStatement dwStmt) {
            indent(i);
            say("while (");
            print(dwStmt.cond, i + 2);
            sayln(")");
    ...
    public static abstract class Expression extends Node {
        ...
        public static class Equality extends Binary {
            public Equality(Token tok, Expression left, Expression right) {
        ...
        public static class Str extends Expression {
            ...
            public Str(Token tok, String value) {
                super(tok, 8);
                this.value = value;
            }
    ...
    public static abstract class Statement extends Node {
        ...
        public static class Call extends Statement {
            ...
            public Call(Token tok, List<Expression> args) {
                super(tok);
                this.id = tok;
                this.args = args;
            }
