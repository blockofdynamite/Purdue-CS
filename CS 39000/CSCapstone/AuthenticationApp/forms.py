...
class RegisterForm(forms.Form):
    ...
    choice = forms.ChoiceField(label="Profession", choices=choices)
...
class StudentUpdateForm(forms.ModelForm):
    class Meta:
        model = Student
        fields = ('java', 'c_sharp', 'c_plus_plus', 'c', 'php', 'python', 'javascript', 'perl', 'sql', 'django')

class EngineerUpdateForm(forms.ModelForm):
    class Meta:
        model = Engineer
        fields = ('alma_mater', 'about', 'contact_info')


class TeacherUpdateForm(forms.ModelForm):
    class Meta:
        model = Teacher
        fields = ('user', 'university', 'contact_info')
